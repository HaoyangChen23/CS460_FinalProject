...
def main():
    ...
    parser.add_argument("--checkpoint_path", type=str, 
                        default="saved_models/transfer_learning/occupancy/cnn.pt", 
                        help="Path to model that is being finetuned")
    parser.add_argument("--num_epochs", type=int, default=20, help="Number of training epochs")
    parser.add_argument("--model_type", type=str, default="cnn", help="Model architecture ['cnn', 'resnet', 'inception']")
    parser.add_argument("--save_path", type=str,
                        default="saved_models/transfer_learning/occupancy/cnn_finetuned.pt",
                        help="Output file")
    parser.add_argument("--train_path", type=str,
                        default="data/transfer_learning/occupancy/train/",
